...
public class EqualsHashcodeExp {
	...
	public static void main(String[] args) {
		...
		employeePojo3.setName("e1");
		employeePojo3.setEmpId("44");
		employeePojo3.setAge(40);
		...
		System.out.println(empList.contains(employeePojo3));
